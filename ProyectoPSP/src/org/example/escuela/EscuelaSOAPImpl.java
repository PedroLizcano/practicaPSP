...
public class EscuelaSOAPImpl implements Escuela {
    ...
    /* (non-Javadoc)
     * @see org.example.escuela.Escuela#escuelaevaluacion(org.example.escuela.EvaluacionRequest parameters)*
     */
    public org.example.escuela.EvaluacionResponse escuelaevaluacion(EvaluacionRequest parameters) {
        ...
        try {
            ...
            _return.setGreet("Greet603117946");
            return _return;
    ...
    public org.example.escuela.AlumnoResponse escuelaalumno(AlumnoRequest parameters) {
        ...
        try {
            ...
            _return.setGreet("Greet-1096906955");
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
    ...
    public org.example.escuela.AsignaturaResponse escuelaasignatura(AsignaturaRequest parameters) {
        ...
        try {
            ...
            _return.setGreet("Greet-1998851588");
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
